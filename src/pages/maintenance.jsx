...
const Maintenance = ({headerHeight, ...props}) => {
       ...
       return (
              <section className='h-screen' style={{ paddingTop: headerHeight, ...styles.document }}>
                     <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
                            ...
                            <h1 style={styles.maintenance.title} className="mb-4">{translations[language].maintenance.title}</h1>
                            <p style={styles.maintenance.description} className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">{translations[language].maintenance.description}</p>
                     </div>
              </section>
